...
void initializeDynamicVariantLegacyPassPass(PassRegistry&);
...
void initializeStaticTDGLegacyPassPass(PassRegistry&);
void initializeStaticTDGIdentLegacyPassPass(PassRegistry&);
...
void initializeTaskDependencyGraphPassPass(PassRegistry&);
